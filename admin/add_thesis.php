                        ...
                        <!-- content starts here -->
                            ...
                            <form method="post" enctype="multipart/form-data" class="form-horizontal form-label-left">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <input type="text" name="code" placeholder="Input code number....." id="first-name2" required="required" class="form-control col-md-7 col-xs-12">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-md-4" for="first-name">Name of Student/s</label>
                                    <div class="col-md-3">
                                        <input type="text" name="name" placeholder="Input name of Student/s....." id="first-name2" class="form-control col-md-7 col-xs-12">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <input type="text" placeholder="Input no. of copy....." required  autocomplete="off" name="quantity" id="last-name2" class="form-control col-md-7 col-xs-12">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <input type="text" placeholder="Input title....."  autocomplete="off" name="title" id="last-name2" class="form-control col-md-7 col-xs-12">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <input type="text" placeholder="Input Date....."  autocomplete="off" name="date" id="last-name2" class="form-control col-md-7 col-xs-12">
                                    </div>
                                </div>  

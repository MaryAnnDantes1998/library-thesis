                        ...
                        <center><h3><strong>You are about to send this lists into "INACTIVE STATUS" </h3></center><br>
                                ...
                                <div class="form-group">
                                 ...
                                 <?php
                                  ...
                                  where ebook_id='$get_id'")or die(mysql_error());
...
mysqli_query($con," INSERT INTO archive (ebook_id,call_no,title,subject,author,editor,edition,pop_id,publisher_id,quantity,date_of_publ,series,isbn_no,accession_no,moa_id,issn_no,notation1,notation2,abstract,remarks,page_no,deyt) VALUES ('$ebook_id','$call_no','$title','$subject','$author','$editor','$edition','$place_of_publ','$publisher','$quantity','$date_of_publ','$series','$isbn_no','$accession_no','$moa','$issn_no','$notation1','$notation2','$abstract','$remark','$page_no','$date') ") or die(mysqli_error($con));

            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h3><i class="fa fa-user-plus"></i> Add Librarians</h3>
                        ...
                        <!-- content starts here -->
                            ...
                            <form method="post" enctype="multipart/form-data" class="form-horizontal form-label-left">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <input type="email" placeholder="Input email or gmail - sample@email.com...."  autocomplete="off" name="email" id="last-name2" class="form-control col-md-7 col-xs-12">
                                    </div>
                                </div>
                                <div class="form-group">

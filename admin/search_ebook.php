            ...
            <div class="box-header with-border">
                <div class="col-md-6 col-md-offset-3">
                                <form method="GET" class="form-horizontal">
                                    <center><h3><strong>Search E-Book</strong></h3></center>
                                   ...
                                   <a class="btn btn-danger" for="DeleteBook" href="#delete<?php echo $id;?>" data-toggle="modal" data-target="#delete<?php echo $id;?>">
                                    ...
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-header">
                                            <h4 style="font-weight: bold" class="modal-title" id="myModalLabel"><i class="glyphicon glyphicon-user"></i> Delete E-Book</h4>
                                        </div>
                                        <div class="modal-body">
                                                ...
                                                <a href="delete_ebook.php<?php echo '?ebook_id='.$id; ?>" style="margin-bottom:5px;" class="btn btn-primary"><i class="glyphicon glyphicon-ok icon-white"></i> Yes</a>
                                                </div>
                                        </div>
                                        </div>
                                    </div>

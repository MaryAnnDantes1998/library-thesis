                    ...
                    <div class="x_content">
                        ...
                        <div class="box">
                            ...
                            <tr>
                                ...
                                <td>
                    <a class="btn btn-primary" for="ViewAdmin" href="userviewebooks.php<?php echo '?ebook_id='.$id; ?>">
                                        <i class="fa fa-eye"></i>
                                    </a>
                                ...
                                -->
                                    ...
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-body">
                                                ...
                                                <a href="delete_user.php<?php echo '?ebook_id='.$id; ?>" style="margin-bottom:5px;" class="btn btn-primary"><i class="glyphicon glyphicon-ok icon-white"></i> Yes</a>
                                                </div>
                                        </div>
                                        </div>
                                    </div>

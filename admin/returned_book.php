...
-->
                        <h2 class="col-xs-10"><i class="fa fa-book"></i> Returned Books Monitoring</h2>
        ...
        <!--- sort -->
                        <form method="POST" action="returned_book_search.php" class="form-inline">
                                ...
                                <button type="submit" name="search" class="btn btn-info"><i class="fa fa-calendar-o"></i> Search By Date Returned</button>
                        ...
                        <div class="box">
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example1">
                                ...
                                <div style="width: 25%; text-align: center;">
                                    <div class="span"><div class="alert alert-warning"><i class="icon-credit-card icon-large"></i>&nbsp;Total Amount of Penalty Received & Paid:&nbsp;<?php echo "Php ".$count_penalty_row['sum(book_penalty)'].".00"; ?></div></div>
                                </div>

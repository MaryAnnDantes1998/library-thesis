            ...
            <div class="box-header with-border">
                <div class="col-md-6 col-md-offset-3">
                                <form method="GET" class="form-horizontal">
                                     <center><h3><i class="fa fa-briefcase"></i><strong> Book Inventory</strong></h3></center>
                    ...
                    <div class="form-group col-md-15">
                             <input placeholder="Sort for Title, Author, Call Number..." type="text" name="search" class="form-control">
                        </div>
                            <center><button name="submit" class="btn btn-lg btn-info">Sort</button></center>
                    </form>
                </div>

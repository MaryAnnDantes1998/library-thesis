...
echo '
     ...
     <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
         ...
         <li class="header" style="color: white">E-BOOK MAINTENANCE</li>
        <li class="treeview">
          <a href="#">
            <i class="fa fa-book"></i>
            <span>E-Books</span>
          ...
          <ul class="treeview-menu">
            <li><a href="ebook.php"><i class="fa fa-plus"></i> Add E-Books</a></li>
            <li><a href="search_ebook.php"><i class="fa fa-search"></i> Search E-books</a></li>
          </ul>
        </li>
        ...
        <li>
         ...
         <li>
          <a href="inventory.php"><i class="fa fa-book"></i> <span>Inventory Books</span></a>
        </li>
        <li class="treeview">
          <a href="#">
            <i class="fa fa-book"></i>
      ...
      elseif($_SESSION['role'] == "Student"){
        ...
        <li>
          <a href="search.php">
            <i class="fa fa-search"></i> <span>Search Book</span>
          </a>
        </li>
        <li>
        <a href="search_ebook.php">
            <i class="fa fa-search"></i> <span>Search E-Book</span>
          </a>
        </li>
        <li>
          <a href="thesis.php">
        ...
        <li>
          <a href="archives.php">
            <i class="fa fa-search"></i> <span>Search Archived Book</span>
          </a>
        </li>
        <li>
        ...
        <li>
          <a href="userebook.php"><i class="fa fa-book"></i> <span>Ebook List</span></a>
        </li>
        <li>
